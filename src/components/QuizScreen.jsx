    ...
    <div className="flex flex-col h-full w-full max-w-[1800px] mx-auto py-2 px-2 sm:px-4 md:px-6">
      ...
      <div className="flex flex-col flex-1 min-h-0 items-center justify-start w-full max-w-[1400px] mx-auto pb-4 px-2 md:px-4">
        ...
        <motion.div
          ...
          className="relative aspect-square w-full max-w-[520px] h-[28vh] sm:h-[32vh] md:h-[36vh] lg:h-[38vh] mb-4 flex items-center justify-center shrink-0 mx-auto"
        >
                  ...
                  >
                    <div className={`w-full p-[2px] ${wrapperBg} kbc-clip-option shadow-lg transition-colors duration-300`}>
                      <button
                        ...
                        className={`relative w-full h-full kbc-clip-option ${innerBg} py-2 md:py-3 px-6 md:px-12 text-left transition-all duration-300 flex items-center justify-between`}
                      >
